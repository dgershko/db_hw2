...
class Test(AbstractTest):
    ...
    def test_add_reservation(self) -> None:
        ...
        self.assertEqual(ReturnValue.BAD_PARAMS, Solution.customer_made_reservation(**res1), 'duplicate reservation add')
    ...
    def test_cancel_reservation(self) -> None:
        ...
        res1 = {'customer_id': 1, 'apartment_id': 1, 'start_date': date(2013, 10, 5), 'end_date': date(2014, 12, 3), 'total_price': 50}
        self.assertEqual(ReturnValue.OK, Solution.customer_made_reservation(**res1), 'add reservation')
        self.assertEqual(ReturnValue.OK, Solution.customer_cancelled_reservation(1, 1, date(2013, 10, 5)), 'cancel reservation')
        self.assertEqual(ReturnValue.NOT_EXISTS, Solution.customer_cancelled_reservation(1, 1, date(2013, 10, 5)), 'cancel non-existant reservation')
    ...
    def test_add_review(self) -> None:
        ...
        self.assertEqual(ReturnValue.ALREADY_EXISTS, Solution.customer_reviewed_apartment(**review1), 'duplicate review add')
        review2 = {'customer_id': 1, 'apartment_id': 1, 'review_date': date(2011, 3, 3),'rating': 6, 'review_text': 'good'}
        self.assertEqual(ReturnValue.NOT_EXISTS, Solution.customer_reviewed_apartment(**review2), 'invalid date review add')
        review3 = {'customer_id': 1, 'apartment_id': 2, 'review_date': date(2015, 3, 3),'rating': 6, 'review_text': 'good'}
        self.assertEqual(ReturnValue.NOT_EXISTS, Solution.customer_reviewed_apartment(**review3), 'invalid apartment review add')
        review4 = {'customer_id': 2, 'apartment_id': 1, 'review_date': date(2015, 3, 3),'rating': 6, 'review_text': 'good'}
        self.assertEqual(ReturnValue.NOT_EXISTS, Solution.customer_reviewed_apartment(**review4), 'invalid customer review add')
        review5 = {'customer_id': 1, 'apartment_id': 1, 'review_date': date(2015, 3, 3),'rating': 15, 'review_text': None}
        self.assertEqual(ReturnValue.BAD_PARAMS, Solution.customer_reviewed_apartment(**review5), 'invalid score review add')
        review6 = {'customer_id': 1, 'apartment_id': 1, 'review_date': date(2015, 3, 3),'rating': 0, 'review_text': None}
        self.assertEqual(ReturnValue.BAD_PARAMS, Solution.customer_reviewed_apartment(**review6), 'invalid score review add')
    ...
    def test_change_review(self) -> None:
        ...
        review2 = {'customer_id': 1, 'apartment_id': 1, 'update_date': date(2015, 4, 4), 'new_rating': 4, 'new_text': 'good'}
        self.assertEqual(ReturnValue.OK, Solution.customer_updated_review(**review2), 'change review')
        review3 = {'customer_id': 2, 'apartment_id': 1, 'update_date': date(2016, 3, 3), 'new_rating': 6, 'new_text': 'good'}
        self.assertEqual(ReturnValue.NOT_EXISTS, Solution.customer_updated_review(**review3), 'change non-existant review')
        review4 = {'customer_id': 1, 'apartment_id': 1, 'update_date': date(2013, 3, 3), 'new_rating': 6, 'new_text': 'bad'}
        self.assertEqual(ReturnValue.NOT_EXISTS, Solution.customer_updated_review(**review4), 'change review to earlier date')
        review5 = {'customer_id': 1, 'apartment_id': 1, 'update_date': date(2016, 3, 3), 'new_rating': 15, 'new_text': 'good'}
        self.assertEqual(ReturnValue.BAD_PARAMS, Solution.customer_updated_review(**review5), 'invalid score review change')
        review6 = {'customer_id': 1, 'apartment_id': 1, 'update_date': date(2016, 3, 3), 'new_rating': 0, 'new_text': 'good'}
        self.assertEqual(ReturnValue.BAD_PARAMS, Solution.customer_updated_review(**review6), 'invalid score review change')
    ...
    def test_owner_owns_apartment(self) -> None:
        ...
        self.assertEqual(ReturnValue.BAD_PARAMS, Solution.owner_owns_apartment(1, 2), 'invalid apartment ownership add')
        self.assertEqual(ReturnValue.BAD_PARAMS, Solution.owner_owns_apartment(2, 1), 'invalid owner ownership add')
...
# =================================== API TESTS ============================================
    def test_apt_rating(self) -> None:
        ...
        res2 = {'customer_id': 2, 'apartment_id': 1, 'start_date': date(2014, 1, 1), 'end_date': date(2014, 2, 2), 'total_price': 50}
        self.assertEqual(ReturnValue.OK, Solution.customer_made_reservation(**res2), 'add reservation')
        review2 = {'customer_id': 2, 'apartment_id': 1, 'review_date': date(2015, 3, 3), 'rating': 4, 'review_text': 'good'}
        self.assertEqual(ReturnValue.OK, Solution.customer_reviewed_apartment(**review2), 'add review')
        
        res3 = {'customer_id': 3, 'apartment_id': 1, 'start_date': date(2015, 1, 1), 'end_date': date(2015, 2, 2), 'total_price': 50}
